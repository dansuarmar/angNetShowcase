...
{
    public class PatchCustomerCommandHandler : IRequestHandler<PatchCustomerCommand, CustomerResult?>
    {
        ...
        public async Task<CustomerResult?> Handle(PatchCustomerCommand request, CancellationToken cancellationToken)
        {
