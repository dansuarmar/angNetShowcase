...
{
    public class GetCustomerByIdQueryHandler : IRequestHandler<GetCustomersByIdQuery, CustomerResponse?>
    {
        ...
        public async Task<CustomerResponse?> Handle(GetCustomersByIdQuery request, CancellationToken cancellationToken)
        {
